...
import OnomyprotocolOnomyOnomyprotocolOnomyIbcdex from './onomyprotocol/onomy/onomyprotocol.onomy.ibcdex';
import CosmosCosmosSdkIbcCoreClientV1 from './cosmos/cosmos-sdk/ibc.core.client.v1';
import OnomyprotocolOnomyOnomyprotocolOnomyMarket from './onomyprotocol/onomy/onomyprotocol.onomy.market';
...
export default {
    OnomyprotocolOnomyOnomyprotocolOnomyIbcdex: load(OnomyprotocolOnomyOnomyprotocolOnomyIbcdex, 'onomyprotocol.onomy.ibcdex'),
    CosmosCosmosSdkIbcCoreClientV1: load(CosmosCosmosSdkIbcCoreClientV1, 'ibc.core.client.v1'),
    OnomyprotocolOnomyOnomyprotocolOnomyMarket: load(OnomyprotocolOnomyOnomyprotocolOnomyMarket, 'onomyprotocol.onomy.market'),
