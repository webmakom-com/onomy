...
export class QueryClientImpl {
    ...
    DenomTrace(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Query", "DenomTrace", data);
    ...
    DenomTraceAll(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Query", "DenomTraceAll", data);
    ...
    BuyOrderBook(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Query", "BuyOrderBook", data);
    ...
    BuyOrderBookAll(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Query", "BuyOrderBookAll", data);
    ...
    SellOrderBook(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Query", "SellOrderBook", data);
    ...
    SellOrderBookAll(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Query", "SellOrderBookAll", data);
