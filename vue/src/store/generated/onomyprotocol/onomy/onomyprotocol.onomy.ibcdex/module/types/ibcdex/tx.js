...
export class MsgClientImpl {
    ...
    CancelBuyOrder(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Msg", "CancelBuyOrder", data);
    ...
    CancelSellOrder(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Msg", "CancelSellOrder", data);
    ...
    SendBuyOrder(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Msg", "SendBuyOrder", data);
    ...
    SendSellOrder(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Msg", "SendSellOrder", data);
    ...
    SendCreatePair(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.ibcdex.Msg", "SendCreatePair", data);
