...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgCancelBuyOrder: (data) => ({ typeUrl: "/onomyprotocol.onomy.ibcdex.MsgCancelBuyOrder", value: data }),
        msgSendCreatePair: (data) => ({ typeUrl: "/onomyprotocol.onomy.ibcdex.MsgSendCreatePair", value: data }),
        msgCancelSellOrder: (data) => ({ typeUrl: "/onomyprotocol.onomy.ibcdex.MsgCancelSellOrder", value: data }),
        msgSendBuyOrder: (data) => ({ typeUrl: "/onomyprotocol.onomy.ibcdex.MsgSendBuyOrder", value: data }),
        msgSendSellOrder: (data) => ({ typeUrl: "/onomyprotocol.onomy.ibcdex.MsgSendSellOrder", value: data }),
    };
};
