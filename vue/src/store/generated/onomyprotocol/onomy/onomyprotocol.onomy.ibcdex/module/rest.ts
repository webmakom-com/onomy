...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/onomyprotocol/onomy/ibcdex/buyOrderBook
   */
  queryBuyOrderBookAll = (
    ...
    this.request<IbcdexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/onomyprotocol/onomy/ibcdex/buyOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/onomyprotocol/onomy/ibcdex/denomTrace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<IbcdexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/onomyprotocol/onomy/ibcdex/denomTrace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/onomyprotocol/onomy/ibcdex/sellOrderBook
   */
  querySellOrderBookAll = (
    ...
    this.request<IbcdexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/onomyprotocol/onomy/ibcdex/sellOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
