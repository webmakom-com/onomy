...
export class QueryClientImpl {
    ...
    Pair(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.market.Query", "Pair", data);
        return promise.then((data) => QueryGetPairResponse.decode(new Reader(data)));
    }
    PairAll(request) {
        const data = QueryAllPairRequest.encode(request).finish();
        const promise = this.rpc.request("onomyprotocol.onomy.market.Query", "PairAll", data);
    ...
    Order(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.market.Query", "Order", data);
    ...
    OrderAll(request) {
        ...
        const promise = this.rpc.request("onomyprotocol.onomy.market.Query", "OrderAll", data);
